        ...
        >
          {isMobile && (
            <>
              ...
              <MenuItem onClick={() => handleClick("books")}>Books</MenuItem>
              <MenuItem onClick={() => handleClick("contests")}>
                Contests
              </MenuItem>
              <MenuItem onClick={() => handleClick("quests")}>Quest</MenuItem>
          ...
          <MenuItem onClick={() => handleClick("createContest/Quest")}>Create Contest / Quest</MenuItem>
        </Menu>
      </Toolbar>
    </AppBar>
  );
